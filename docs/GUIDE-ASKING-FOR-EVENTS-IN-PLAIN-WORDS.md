...
- **Try in a scratch sheet** - the same rows open in a scratch tab instead: a real sheet with no
  file behind it, so you can run your eye over them, edit them, and copy across what you want.

...
- **Streaming and tutorials.** A big-font, high-contrast theme makes rows legible in a 720p video - switch it on in *Menu ▸ View ▸ Sheet theme* before recording.
- **Ship the team preset in the repo.** The theme package is a folder of `.tres` files; commit it and everyone's editor matches after one pick in *Menu ▸ View ▸ Sheet theme*.
...
- **Two themes for two hats.** Keep a calm low-contrast package for authoring long sessions and a punchy high-contrast one for pair-review calls; *Menu ▸ View ▸ Sheet theme* flips between them in a click with no file dialog.

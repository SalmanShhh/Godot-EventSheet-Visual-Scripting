...
6. [Full Reference](#6-full-reference)
...
`compile()`'s Dictionary keys: `"output"` (the source text: this key, not "source"), `"success"`, `"errors"`, `"warnings"`, `"source_map"`.

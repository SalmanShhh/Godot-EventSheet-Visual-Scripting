...
- **Movement & feel** - Platformer (+ jump-graph **Platformer Pathfinding**), 8-Direction, Tile/Slide Movement, Car + **Physics Car**, Sine/Orbit/Bullet/Move To/Follow (with 3D twins + **Nav Agent 3D**) + **Follow A Path**, Spring, Tween, Fade, Flash, Rotate, Bound To + Wrap, **FPS Controller** (crouch/slide/wall tech), **Juice** 2D + 3D (shake/recoil/bob/zoom/slowmo/hitstop/tints).

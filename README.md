...
1. Copy `addons/eventforge/` and `addons/eventsheet/` into your Godot **4.5+** project (tested through **4.7 stable**). Optional: `eventsheet_addons/` for the 130 behavior packs. Removal is clean - see [uninstall](docs/GUIDE-UNINSTALL.md).
...
- **130 behavior packs**, all authored as event sheets - movement and feel, AI, combat and stats, narrative, drawing and UI, lighting, shader effects, and system packs. See [docs/Addons/](docs/Addons/README.md).
...
| `eventsheet_addons/` | Zero-config ACE addons + the 130 behavior packs |

...
- **Pack builders auto-register** - drop a builder in `tools/pack_builders/` and it registers itself, no list to maintain; the suite is now 58 packs.

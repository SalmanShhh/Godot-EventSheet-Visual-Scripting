...
const MARKS: Array[Dictionary] = [
	...
	{"mark": "not", "name": "Inverted condition",
		"help": "The condition is true when the opposite is. A comparison shows the opposite operator instead (hp > 0), so this mark is for the tests that have none."},
	{"mark": "⏸", "name": "Disabled",

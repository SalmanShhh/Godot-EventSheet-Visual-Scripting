...
func _ensure_find_bar() -> void:
	...
	# The event-sheet live filter: toggling FILTERS the sheet to matching events instead of just
	...
	lens_button.tooltip_text = "Show ONLY the events matching the search (live filter). Esc clears."

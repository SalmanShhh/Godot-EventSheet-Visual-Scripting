...
func _on_translations_maybe_changed() -> void:
	...
	# And the warm asks for them again during idle, rather than leaving the next open to pay for
	# everything this ping just dropped.
	EventSheetPickerWarmup.rearm()

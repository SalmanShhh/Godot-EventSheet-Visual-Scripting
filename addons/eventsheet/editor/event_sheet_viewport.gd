...
var _layout_builder: ViewportLayoutBuilder = ViewportLayoutBuilder.new()  # per-row geometry pass (interaction/viewport_layout_builder.gd)  # fold gestures + region fold persistence (interaction/viewport_folding.gd)

...
@export_multiline var designer_usage_hint: String = "Use this scene as the designer-friendly template for one event-sheet-style lane entry. The button chrome maps to the name cell, while the text preview stands in for the readable description/value content shown in the stacked EventSheet lane."

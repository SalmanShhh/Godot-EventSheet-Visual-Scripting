...
- [Multiplayer with Godot's Built-in Tools](GUIDE-MULTIPLAYER-WITH-GODOTS-BUILT-IN-TOOLS.md) - playing together over a network as rows: hosting and joining, the seven things the connection tells you, who is in the game and who sent this, a group that says who runs it, objects and their owners, the lobby and the authentication handshake, and what a project you already wrote opens as.

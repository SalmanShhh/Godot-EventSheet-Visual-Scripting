...
| `eventsheet_addons/**/*.gd` - behavior packs, and the runtime classes the emitted code calls (`free_spot.gd`, `pooled_nodes.gd`, `world_look.gd`), are plain `class_name` classes the game uses | `addons/eventsheet/` |

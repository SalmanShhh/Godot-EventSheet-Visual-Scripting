...
func refresh_from_sources(sources: Array[Object], include_builtin: bool = true) -> void:
    ...
    for source_object: Object in sources:
        if source_object == null:
            continue
        for definition: ACEDefinition in _generator.generate_from_object(source_object):
...
func get_provider_definitions(provider_id: String) -> Array[ACEDefinition]:
    ...
    for definition: ACEDefinition in _definitions:

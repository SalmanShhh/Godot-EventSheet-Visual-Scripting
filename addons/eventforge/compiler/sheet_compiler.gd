...
static func compile(sheet: EventSheetResource, output_path: String = "") -> Dictionary:
	...
	if not sheet.includes.is_empty():
		...
		_merge_includes(sheet, all_events, all_functions, merged_variables, visited, result["warnings"])
...
static func _merge_includes(sheet: EventSheetResource, all_events: Array, all_functions: Array, merged_variables: Dictionary, visited: Dictionary, warnings: Array) -> void:

...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(F.make_descriptor("Core", "AddToGroup", "Add To Group", ACEDescriptor.ACEType.ACTION, "{target}.add_to_group({group})", "", [F.make_param("target", "String", "self", "Target", "Node to tag.", "expression"), F.make_param("group", "String", "\"enemies\"", "Group", "Group name.", "group_reference")], "Groups", "add {target} to {group}")
		.described("Tags a node into a named group so you can find or affect it later."))
	descriptors.append(F.make_descriptor("Core", "RemoveFromGroup", "Remove From Group", ACEDescriptor.ACEType.ACTION, "{target}.remove_from_group({group})", "", [F.make_param("target", "String", "self", "Target", "Node to untag.", "expression"), F.make_param("group", "String", "\"enemies\"", "Group", "Group name.", "group_reference")], "Groups", "remove {target} from {group}")
		.described("Untags a node from a named group when it should no longer belong."))
	descriptors.append(F.make_descriptor("Core", "IsInGroup", "Is In Group", ACEDescriptor.ACEType.CONDITION, "{target}.is_in_group({group})", "", [F.make_param("target", "String", "self", "Target", "Node to test.", "expression"), F.make_param("group", "String", "\"enemies\"", "Group", "Group name.", "group_reference")], "Groups", "{target} in {group}")

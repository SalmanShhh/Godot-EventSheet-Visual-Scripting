...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(F.make_descriptor("Core", "SetProperty", "Set Property", ACEDescriptor.ACEType.ACTION, "{target}.{property} = {value}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression (self, $Path, a variable).", "expression"), F.make_param("property", "String", "modulate", "Property", "Property name (e.g. modulate, visible, position)."), F.make_param("value", "String", "Color.WHITE", "Value", "Value expression to assign.", "expression")], CAT, "set {target}.{property} = {value}"))
	descriptors.append(F.make_descriptor("Core", "GetProperty", "Get Property", ACEDescriptor.ACEType.EXPRESSION, "{target}.{property}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression.", "expression"), F.make_param("property", "String", "visible", "Property", "Property name to read.")], CAT, "{target}.{property}"))
	# Call ANY method, as a fire-and-forget action or as a value-returning expression.
	descriptors.append(F.make_descriptor("Core", "CallMethod", "Call Method", ACEDescriptor.ACEType.ACTION, "{target}.{method}({args})", "", [F.make_param("target", "String", "self", "Target", "Node/object expression.", "expression"), F.make_param("method", "String", "queue_free", "Method", "Method name to call."), F.make_param("args", "String", "", "Arguments", "Comma-separated argument expressions (may be empty).", "expression")], CAT, "{target}.{method}({args})"))
	descriptors.append(F.make_descriptor("Core", "CallMethodValue", "Call Method (value)", ACEDescriptor.ACEType.EXPRESSION, "{target}.{method}({args})", "", [F.make_param("target", "String", "self", "Target", "Node/object expression.", "expression"), F.make_param("method", "String", "get_index", "Method", "Method name to call."), F.make_param("args", "String", "", "Arguments", "Comma-separated argument expressions.", "expression")], CAT, "{target}.{method}({args})"))

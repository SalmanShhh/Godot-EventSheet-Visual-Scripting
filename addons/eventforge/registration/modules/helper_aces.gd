...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(F.make_descriptor("Core", "EmitSignalOn", "Emit Signal On", ACEDescriptor.ACEType.ACTION, "{target}.emit_signal({signal}{, args})", "", [F.make_param("target", "String", "self", "Target", "Object that owns the signal.", "expression"), F.make_param("signal", "String", "\"died\"", "Signal", "Signal name.", "signal_reference:quoted"), F.make_param("args", "String", "", "Arguments", "Optional signal arguments.")], CAT, "emit {target}.{signal}"))

...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(F.make_descriptor("Core", "AddToProperty", "Add To Property", ACEDescriptor.ACEType.ACTION, "{target}.{property} += {value}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression (self, $Path, a variable).", "expression"), F.make_param("property", "String", "position", "Property", "Property name (e.g. position, rotation).", "property_reference"), F.make_param("value", "String", "Vector2(1, 0)", "Value", "Amount to add to the property.", "expression")], CAT, "{target}.{property} += {value}")
		.described("Adds an amount to a node's property, like nudging position or raising an alpha."))
	descriptors.append(F.make_descriptor("Core", "SubtractFromProperty", "Subtract From Property", ACEDescriptor.ACEType.ACTION, "{target}.{property} -= {value}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression (self, $Path, a variable).", "expression"), F.make_param("property", "String", "position", "Property", "Property name (e.g. position, modulate.a).", "property_reference"), F.make_param("value", "String", "Vector2(1, 0)", "Value", "Amount to subtract from the property.", "expression")], CAT, "{target}.{property} -= {value}")
		.described("Subtracts an amount from a node's property, like fading an alpha down."))
	descriptors.append(F.make_descriptor("Core", "MultiplyProperty", "Multiply Property", ACEDescriptor.ACEType.ACTION, "{target}.{property} *= {value}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression (self, $Path, a variable).", "expression"), F.make_param("property", "String", "scale", "Property", "Property name (e.g. scale).", "property_reference"), F.make_param("value", "String", "1.1", "Value", "Factor to multiply the property by.", "expression")], CAT, "{target}.{property} *= {value}")
		.described("Scales a node's property by a factor, like growing a sprite's scale."))
	descriptors.append(F.make_descriptor("Core", "DivideProperty", "Divide Property", ACEDescriptor.ACEType.ACTION, "{target}.{property} /= {value}", "", [F.make_param("target", "String", "self", "Target", "Node/object expression (self, $Path, a variable).", "expression"), F.make_param("property", "String", "scale", "Property", "Property name (e.g. scale).", "property_reference"), F.make_param("value", "String", "2.0", "Value", "What to divide the property by.", "expression")], CAT, "{target}.{property} /= {value}")
		.described("Divides a node's property by a value, like shrinking a sprite's scale."))
	...
	descriptors.append(F.make_descriptor("Core", "ClampIntValue", "Clamp (int)", ACEDescriptor.ACEType.EXPRESSION, "clampi({value}, {min}, {max})", "", [F.make_param("value", "String", "0", "Value", "Whole-number value to clamp.", "expression"), F.make_param("min", "String", "0", "Min", "Lower bound.", "expression"), F.make_param("max", "String", "10", "Max", "Upper bound.", "expression")], CAT, "clampi({value}, {min}, {max})")
		.described("Keeps a whole number within a min and max - use this (not the float clamp) for scores, health, and ammo."))
	descriptors.append(F.make_descriptor("Core", "WrapIntValue", "Wrap (int)", ACEDescriptor.ACEType.EXPRESSION, "wrapi({value}, {min}, {max})", "", [F.make_param("value", "String", "0", "Value", "Whole-number value to wrap.", "expression"), F.make_param("min", "String", "0", "Min", "Lower bound (inclusive).", "expression"), F.make_param("max", "String", "10", "Max", "Upper bound (exclusive).", "expression")], CAT, "wrapi({value}, {min}, {max})")
		.described("Wraps a whole number around a range - perfect for cycling a menu or inventory index past the ends back to the start."))

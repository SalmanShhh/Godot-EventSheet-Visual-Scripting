...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(_make_descriptor("Core", "KeyIsDown", "Key Is Down", ACEDescriptor.ACEType.CONDITION, "Input.is_physical_key_pressed({key})", "", [_make_param("key", "String", "KEY_SPACE", "Key", "Press a key to capture it.", "key_capture")], "Keyboard", "Key {key} is down"))
	descriptors.append(_make_descriptor("Core", "KeyEventPressed", "On Key Pressed (event)", ACEDescriptor.ACEType.CONDITION, "(event is InputEventKey and event.pressed and not event.echo and event.physical_keycode == {key})", "", [_make_param("key", "String", "KEY_SPACE", "Key", "Use inside an On Input event.", "key_capture")], "Keyboard", "On {key} pressed"))
	descriptors.append(_make_descriptor("Core", "KeyEventReleased", "On Key Released (event)", ACEDescriptor.ACEType.CONDITION, "(event is InputEventKey and not event.pressed and event.physical_keycode == {key})", "", [_make_param("key", "String", "KEY_SPACE", "Key", "Use inside an On Input event.", "key_capture")], "Keyboard", "On {key} released"))
	descriptors.append(_make_descriptor("Core", "MouseButtonDown", "Mouse Button Is Down", ACEDescriptor.ACEType.CONDITION, "Input.is_mouse_button_pressed({button})", "", [_make_param("button", "String", "MOUSE_BUTTON_LEFT", "Button", "Mouse button.", "", ["MOUSE_BUTTON_LEFT", "MOUSE_BUTTON_RIGHT", "MOUSE_BUTTON_MIDDLE"])], "Mouse", "{button} is down"))
	descriptors.append(_make_descriptor("Core", "GetMouseWorldPosition", "Mouse Position (world)", ACEDescriptor.ACEType.EXPRESSION, "get_global_mouse_position()", "", [], "Mouse", "mouse position", "Node2D"))
	descriptors.append(_make_descriptor("Core", "GetMouseScreenPosition", "Mouse Position (screen)", ACEDescriptor.ACEType.EXPRESSION, "get_viewport().get_mouse_position()", "", [], "Mouse", "mouse screen position"))
	descriptors.append(_make_descriptor("Core", "SetMouseMode", "Set Mouse Mode", ACEDescriptor.ACEType.ACTION, "Input.mouse_mode = {mode}", "", [_make_param("mode", "String", "Input.MOUSE_MODE_VISIBLE", "Mode", "Cursor visibility/capture.", "", ["Input.MOUSE_MODE_VISIBLE", "Input.MOUSE_MODE_HIDDEN", "Input.MOUSE_MODE_CAPTURED", "Input.MOUSE_MODE_CONFINED"])], "Mouse", "Set mouse mode {mode}"))
	descriptors.append(_make_descriptor("Core", "JoyButtonDown", "Gamepad Button Is Down", ACEDescriptor.ACEType.CONDITION, "Input.is_joy_button_pressed({device}, {button})", "", [_make_param("device", "String", "0", "Gamepad", "Device index (0 = first).", "expression"), _make_param("button", "String", "JOY_BUTTON_A", "Button", "Gamepad button.", "", ["JOY_BUTTON_A", "JOY_BUTTON_B", "JOY_BUTTON_X", "JOY_BUTTON_Y", "JOY_BUTTON_LEFT_SHOULDER", "JOY_BUTTON_RIGHT_SHOULDER", "JOY_BUTTON_START", "JOY_BUTTON_BACK", "JOY_BUTTON_DPAD_UP", "JOY_BUTTON_DPAD_DOWN", "JOY_BUTTON_DPAD_LEFT", "JOY_BUTTON_DPAD_RIGHT"])], "Gamepad", "Gamepad {button} is down"))
	descriptors.append(_make_descriptor("Core", "GetJoyAxis", "Gamepad Axis", ACEDescriptor.ACEType.EXPRESSION, "Input.get_joy_axis({device}, {axis})", "", [_make_param("device", "String", "0", "Gamepad", "Device index.", "expression"), _make_param("axis", "String", "JOY_AXIS_LEFT_X", "Axis", "Stick/trigger axis.", "", ["JOY_AXIS_LEFT_X", "JOY_AXIS_LEFT_Y", "JOY_AXIS_RIGHT_X", "JOY_AXIS_RIGHT_Y", "JOY_AXIS_TRIGGER_LEFT", "JOY_AXIS_TRIGGER_RIGHT"])], "Gamepad", "gamepad axis {axis}"))
	descriptors.append(_make_descriptor("Core", "GamepadConnected", "Gamepad Is Connected", ACEDescriptor.ACEType.CONDITION, "Input.get_connected_joypads().has({device})", "", [_make_param("device", "String", "0", "Gamepad", "Device index.", "expression")], "Gamepad", "gamepad {device} connected"))
	descriptors.append(_make_descriptor("Core", "StartJoyVibration", "Vibrate Gamepad", ACEDescriptor.ACEType.ACTION, "Input.start_joy_vibration({device}, {weak}, {strong}, {duration})", "", [_make_param("device", "String", "0", "Gamepad", "Device index.", "expression"), _make_param("weak", "String", "0.5", "Weak", "Weak motor 0..1.", "expression"), _make_param("strong", "String", "0.5", "Strong", "Strong motor 0..1.", "expression"), _make_param("duration", "String", "0.3", "Seconds", "Duration.", "expression")], "Gamepad", "Vibrate gamepad {duration}s"))
	descriptors.append(_make_descriptor("Core", "IsTouchscreen", "Touchscreen Available", ACEDescriptor.ACEType.CONDITION, "DisplayServer.is_touchscreen_available()", "", [], "Touch", "device has a touchscreen"))
	descriptors.append(_make_descriptor("Core", "TouchEventPressed", "On Touch (event)", ACEDescriptor.ACEType.CONDITION, "(event is InputEventScreenTouch and event.pressed)", "", [], "Touch", "On touch"))
	descriptors.append(_make_descriptor("Core", "TouchEventReleased", "On Touch Released (event)", ACEDescriptor.ACEType.CONDITION, "(event is InputEventScreenTouch and not event.pressed)", "", [], "Touch", "On touch released"))
	descriptors.append(_make_descriptor("Core", "GetTouchPosition", "Touch Position (event)", ACEDescriptor.ACEType.EXPRESSION, "event.position", "", [], "Touch", "touch position"))

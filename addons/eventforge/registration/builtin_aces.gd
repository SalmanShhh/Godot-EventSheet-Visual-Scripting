...
static func get_descriptors() -> Array[ACEDescriptor]:
	...
	descriptors.append(_make_descriptor("Core", "CompareValue", "Compare Values", ACEDescriptor.ACEType.CONDITION, "{left} {op} {right}", "", [_make_param("left", "String", "0", "Left", "Left value or expression."), _make_param("op", "String", "==", "Operator", "Comparison operator.", "", COMPARISON_OPERATORS), _make_param("right", "String", "0", "Right", "Right value or expression.")], "General Conditions", "{left} {op} {right}"))

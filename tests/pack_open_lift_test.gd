...
static func run() -> bool:
	...
	all_passed = _check("the fleet was scanned (91 packs)", packs, 91) and all_passed
	...
	all_passed = _check("fleet-wide declared verbs count matches the catalog (1269)", total_verbs, 1269) and all_passed

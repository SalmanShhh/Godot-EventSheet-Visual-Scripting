# Godot EventSheets - save_system pack: truthful On Save Written.
#
...
# succeeds. This drives real user:// I/O to prove the signal is truthful. That a saved value reads back
# is spring_tween_packs_test's, on the same slot.
@tool

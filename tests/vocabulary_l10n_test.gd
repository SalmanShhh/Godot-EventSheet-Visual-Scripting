...
const FULLY_KEYED_ACES: Array[String] = [
	...
	"MatchesPropertiesOf", "MaterialBlend", "MaterialColour", "MaterialFadeColour",
	"MaterialFadeGlow", "MaterialFadeMetal", "MaterialFadeRoughness", "MaterialFadeSeeThrough",
	"MaterialGlow", "MaterialMetal", "MaterialRoughness", "MaterialSeeThrough", "MaterialSetBlend",
	"MaterialSetColour", "MaterialSetGlow", "MaterialSetMetal", "MaterialSetRoughness",
	"MaterialSetSeeThrough", "MaterialSetSides", "MaterialSetTexture", "MaterialSetTransparency",
	"MaterialSides", "MaterialTexture", "MaterialTransparency",

...
static func run() -> bool:
	...
	ok = _check("On Project Export is in the Editor Tools family",
		str((descriptors.get("OnProjectExport", ACEDescriptor.new()) as ACEDescriptor).category), "Editor Tools") and ok

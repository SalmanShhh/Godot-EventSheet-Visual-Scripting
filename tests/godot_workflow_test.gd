...
static func run() -> bool:
	...
	all_passed = _check("Sheet/Add/Edit/View menus carry the consolidated actions",
		sheet_menu != null and sheet_menu.get_popup().item_count == 23  # +New shared sheet… (V11), +Start page, +Preview entries (project UX 1), +Save as Text…, +New Behaviour Addon…, +Teach a Verb, +Inspector Designer, +New Editor Tool…, +New Custom Resource…, +Publish New Version…, +separator +Name Raw Calls…

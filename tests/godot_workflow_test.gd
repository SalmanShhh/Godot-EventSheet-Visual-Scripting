...
static func run() -> bool:
	...
	all_passed = _check("Sheet/Add/Edit/View menus carry the consolidated actions",
		...
		and view_menu != null and view_menu.get_popup().item_count == 23, true) and all_passed  # +1: Open Sheets Panel, +1: Language submenu, +1: Object Icons toggle, +1: Event Numbers toggle, +1: Outline, +1: Aligned Object Columns

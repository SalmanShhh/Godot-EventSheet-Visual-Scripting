...
- **Tutorials, in the live editor, on a sheet nobody minds losing.** Manual ▸ Tutorials lists five:
  *Your first event*, *Open your own script as a sheet*, *Add a behavior to an object*, *Make a
  function and call it*, and *Coming from another event-sheet editor*. Each is a sequence of step

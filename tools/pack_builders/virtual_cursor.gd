...
static func build() -> bool:
	...
	sheet.variables = {
		...
		"ai_controlled": {"type": "bool", "default": false, "exported": true, "attributes": {"tooltip": "AI drive: read ai_move_x/ai_move_y instead of the ui_* actions (a sheet or AI driver flips this on to steer the cursor)."}},
